...
/**
 * Profile "Devices" section (anti-account-sharing v1): shows the account's
 * registered devices and offers "Sign out all other devices" — the owner's
 * lever for evicting borrowed sessions. Push tokens for evicted devices are
 * pruned too (revoking refresh tokens alone doesn't stop notifications).
 */
