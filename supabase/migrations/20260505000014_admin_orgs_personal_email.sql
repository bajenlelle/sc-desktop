-- Extend get_all_orgs_with_counts to return is_personal + the personal org's
-- owner email. Used by the platform admin page to display the user's email
-- instead of the generic "Personal" label.
